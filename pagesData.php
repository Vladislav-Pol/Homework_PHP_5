...
$arPages = [
    ...
    "blog" => [
        "name" => "Blog",
        "link" => "/Homework_PHP_5/page.php?id=blog",
        "content" => [
            "post1" => [
    ...
    "portfolio" => [
        "name" => "Portfolio",
        "link" => "/Homework_PHP_5/page.php?id=portfolio"
    ],
    "contact" => [
        "name" => "Contact",
        "link" => "/Homework_PHP_5/page.php?id=contact"
    ]
];
...
if (isset($_GET["id"]) && $_GET["id"] == "contact") {
    if(!isset($_REQUEST["sendMessage"]) || !validateFormData()) {
